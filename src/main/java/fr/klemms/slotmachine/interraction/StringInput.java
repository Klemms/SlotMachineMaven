...
public class StringInput {
	...
	public static void inputString(Player player, String title, String placeholder, StringInputCallback callback, boolean allowNoChange, boolean showPlaceholders, boolean showPlaceholdersAPI) {
		inputString(player, title, placeholder, callback, allowNoChange, showPlaceholders, showPlaceholdersAPI, new ItemStack(Material.COMMAND_BLOCK), new ItemStack(PlayerHeadsUtil.INFOS));
	}

	public static void inputString(Player player, String title, String placeholder, StringInputCallback callback, boolean allowNoChange, boolean showPlaceholders, boolean showPlaceholdersAPI, ItemStack leftItem, ItemStack rightItem) {
		...
		new AnvilGUI.Builder()
				...
				.title(title)
				.itemLeft(ItemStackUtil.changeItemStackName(new ItemStack(leftItem), ChatContent.GOLD + "Validate with the green button"))
				.itemRight(showPlaceholders ? ItemStackUtil.setItemStackLore(ItemStackUtil.changeItemStackName(new ItemStack(rightItem), ChatContent.GOLD + "You can use those placeholders :"), variableLore) : null)
